...
Compose stability (separate, report-only): `python3 scripts/compose-stability.py [:module:path ...] [--uncertain]` regenerates the Compose compiler reports and prints unstable params and non-skippable composables, one line each.
